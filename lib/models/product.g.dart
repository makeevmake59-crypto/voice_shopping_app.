...
void _productSerialize(
  ...
  writer.writeBool(offsets[3], object.isBought);
...
Product _productDeserialize(
  ...
  object.isBought = reader.readBool(offsets[3]);
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> isBoughtEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isBought',
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByIsBought() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBought', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByIsBoughtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByIsBought() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBought', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByIsBoughtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBought', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByIsBought() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, bool, QQueryOperations> isBoughtProperty() {
    return QueryBuilder.apply(this, (query) {
